...
def initial_phonebook():
    rows, cols = int(input("Please etner initial number of contacts: ")), 5
...
def menu():
        ...
        print("3. Delte all contacts")
        print("4. Search for a contact")
        print("5. Display all contacts")
        print("6. Ext phonebook")
...
def search_existing(pb):
        ...
        if choice == 1:
                ...
                for i in range(len(pb)):
                        ...
                        query = str(
                                input("Please enter the DOB\ (in dd/mm/yy format ONLY)\ of the conatct you wish to search:"))
                        for i in range(len(pb)):
                                    if query == pb[i][3]:
                                            check = i 
                                            temp.append(pb[i])
